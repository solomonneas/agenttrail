...
- Keep StationTrail focused on exporting local agent session logs to `miseledger.adapter.v1` JSONL.
- Do not add archive, SQLite, search, evidence bundle, GUI, or server behavior here. Those belong in MiseLedger.
